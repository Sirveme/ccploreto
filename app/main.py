...
from app.routers.condiciones_admin import router as condiciones_admin_router
...
app.include_router(condiciones_admin_router)   # Presets de Condiciones/Exoneraciones (lectura, Paso 4)
